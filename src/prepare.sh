...
mkdir -p "${PATH_TO_CERTS:-/corelab_netapp/capif_onboarding}"
...
evolved5g register-and-onboard-to-capif --config_file_full_path="/corelab_netapp/capif_registration.json" &
