...
from zortenet.interop.a2a_tasks import A2ATaskManager, message_text
...
def build_default_specialists(
    ...
    from zortenet.packs.netops_copilot import build_registry as netops_registry
    from zortenet.packs.ran_opt_copilot import build_registry as ran_registry
