...
from zortenet.train.gates import GATE_ORDER, TrainingGates
...
def generate_model_card(
    gates: TrainingGates,
    model_name: str = "zortenet-netops-lora",
    ...
    lines = [
        ...
        "[ZorteNet toolkit](https://github.com/akiskourtis/Agentic-5G-Monitoring-Skill).",
        "",
