...
from zortenet.agent.tools import ToolRegistry, registry as default_registry
...
def create_server(registry: Optional[ToolRegistry] = None, name: str = "zortenet-5g"):
...
async def run_stdio(registry: Optional[ToolRegistry] = None, name: str = "zortenet-5g") -> None:  # pragma: no cover
