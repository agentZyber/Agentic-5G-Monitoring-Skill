...
def synth_uc_trajectories(n_per_uc: int = 20, seed: int = 42, use_cases=None) -> List[Dict[str, Any]]:
    ...
    import importlib
    from corelab.core.bus import EventStore
    from corelab.core.events import EventDomain as D, NetworkEvent as E, Severity as S
    ...
    specs = [
        ("energy-agent", "corelab.packs.energy_agent", "cell-{n}", ("assess_cell_energy", "cell_id"),
        ...
        ("xr-qoe", "corelab.packs.xr_qoe", "flow-{n}", ("assess_xr_flow", "entity_id"),
        ...
        ("v2x-ops", "corelab.packs.v2x_ops", "veh-{n}", ("assess_vehicle", "entity_id"),
        ...
        ("uav-ops", "corelab.packs.uav_ops", "uav-{n}", ("assess_aerial_ue", "entity_id"),
        ...
        ("ntn-ops", "corelab.packs.ntn_ops", "term-{n}", ("assess_ntn_terminal", "entity_id"),
        ...
        ("sensing-ops", "corelab.packs.sensing_ops", "scell-{n}", ("assess_sensing_cell", "entity_id"),
        ...
        ("ai-native", "corelab.packs.ai_native", "slice-{n}", ("assess_analytics", "entity_id"),
        ...
        ("massive-iot", "corelab.packs.massive_iot", "cell-{n}", ("assess_iot_cell", "entity_id"),
