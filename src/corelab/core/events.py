...
The original CORE Lab NCSRD hard-coded a single ``LocationEvent`` (cell id + mobility). That is the
...
class EventDomain(str, Enum):
    ...
    LOCATION = "location"        # UE location / mobility (the legacy CORE Lab NCSRD domain)
...
class NetworkEvent:
    ...
    def from_location_event(cls, data: Dict[str, Any], source: str = "nef") -> "NetworkEvent":
        """Bridge the legacy CORE Lab NCSRD location callback shape into a NetworkEvent.
