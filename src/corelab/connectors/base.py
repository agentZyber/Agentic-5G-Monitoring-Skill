...
CONNECTOR_CATALOG: Dict[str, ConnectorInfo] = {
    "prometheus": ConnectorInfo(
        ...
        capabilities=("read",),
        module="corelab.connectors.prometheus",
    ),
    "open5gs": ConnectorInfo(
        ...
        capabilities=("read",),
        module="corelab.connectors.open5gs",
    ),
    "ueransim": ConnectorInfo(
        ...
        module="corelab.connectors.ueransim",
    ),
    "nwdaf": ConnectorInfo(
        name="nwdaf",
        ...
        domains=("qos", "slice"),
        capabilities=("read",),
        module="corelab.connectors.nwdaf",
    ...
    "amarisoft": ConnectorInfo(
        ...
        capabilities=("read", "control", "fault-injection"),
        module="corelab.connectors.amarisoft",
    ...
    "a1-ric": ConnectorInfo(
        ...
        module="corelab.connectors.a1_ric",
