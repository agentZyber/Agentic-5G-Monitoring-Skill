...
from corelab.agent.runtime import AgentResult, AgentRuntime
from corelab.core.bus import EventBus
from corelab.core.events import EventDomain, NetworkEvent, Severity
from corelab.intent.ledger import IntentLedger, IntentStatus
...
def run_teleagent_bench(
    ...
    ``trajectory`` (a :class:`~corelab.agent.trajectory.TrajectoryLogger`) turns benchmark runs
