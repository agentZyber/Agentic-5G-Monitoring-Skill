"""CLI: python -m corelab.datasets list | pull <name> [--root DIR]"""

from __future__ import annotations

import argparse

from corelab.datasets.pull import DEFAULT_ROOT, pull
from corelab.datasets.registry import list_datasets


def main(argv=None) -> int:
    parser = argparse.ArgumentParser(prog="corelab-datasets")
