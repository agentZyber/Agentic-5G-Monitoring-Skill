"""location-monitor — the legacy CORE Lab NCSRD capability, repackaged as the first capability pack.
...
from corelab.core.events import NetworkEvent, Severity

PACK: Dict[str, Any] = {
    "name": "location-monitor",
    "description": "UE location/mobility monitoring and geofence policy (legacy CORE Lab NCSRD capability).",
