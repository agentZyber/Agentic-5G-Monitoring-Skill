"""CLI: python -m corelab.packs.telco_bench [--data PATH] [--provider ollama] [--model M] [--limit N]"""
...
from corelab.packs.telco_bench.data import TELEQNA_URL, fetch_teleqna, load_teleqna
from corelab.packs.telco_bench.runner import run_benchmark, to_markdown
