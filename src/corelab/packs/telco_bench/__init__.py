...
Usage:
    python -m corelab.packs.telco_bench --data TeleQnA.txt --limit 200
    python -m corelab.packs.telco_bench --provider ollama --model qwen2.5:7b
"""

from corelab.packs.telco_bench.data import MCQItem, fetch_teleqna, load_teleqna
from corelab.packs.telco_bench.runner import BenchResult, build_prompt, parse_choice, run_benchmark, to_markdown
