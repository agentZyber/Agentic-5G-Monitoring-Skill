...
first-class pack. Wraps :class:`~corelab.connectors.amarisoft.AmarisoftClient` (remote WS API,
...
Opt-in (not in DEFAULT_PACKS): enable with ``CORELAB_PACKS=...,amarisoft`` + the env URLs.
